...
import edu.sxccal.cmsa.audio.JSoundCapture;
...
import edu.sxccal.cmsa.mediator.Operations;
import edu.sxccal.cmsa.util.ErrorManager;
import edu.sxccal.cmsa.util.Utils;
...
public class HMM_VQ_Speech_Recognition extends JFrame {
	...
	private JLabel getAboutLBL( ) {
		if ( aboutLBL == null ) {
			aboutLBL = new JLabel( "Developer: Santanu Mondal, Kalyan Majumdar, Srijita Biswas" );
