package edu.sxccal.cmsa.audio;

import edu.sxccal.cmsa.audio.feature.Delta;
import edu.sxccal.cmsa.audio.feature.Energy;
import edu.sxccal.cmsa.audio.feature.FeatureVector;
import edu.sxccal.cmsa.audio.feature.MFCC;

/**
 * Feature extraction, cepstral mean substraction, and merging with deltas
 * 
 * @author Kalyan Majumdar, Srijita Biswas, Santanu Mondal
 */
public class FeatureExtract {
	...
	public FeatureExtract( float[][] framedSignal, int samplingRate, int samplePerFrame ) {
		...
		mfcc = new MFCC( this.samplePerFrame, samplingRate, numCepstra );
