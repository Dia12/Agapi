package edu.sxccal.cmsa.mediator;

import java.io.File;
import java.util.List;
import java.util.ArrayList;

import edu.sxccal.cmsa.audio.FeatureExtract;
import edu.sxccal.cmsa.audio.FormatControlConf;
import edu.sxccal.cmsa.audio.PreProcess;
import edu.sxccal.cmsa.audio.WaveData;
import edu.sxccal.cmsa.audio.feature.FeatureVector;
import edu.sxccal.cmsa.classify.speech.HiddenMarkov;
import edu.sxccal.cmsa.classify.speech.vq.Codebook;
import edu.sxccal.cmsa.classify.speech.vq.Points;
import edu.sxccal.cmsa.db.DataBase;
import edu.sxccal.cmsa.db.ObjectIODataBase;
import edu.sxccal.cmsa.db.TrainingTestingWaveFiles;
import edu.sxccal.cmsa.util.ArrayWriter;
